function Controller() {
    ...
    $.__views.index.add($.__views.sendButton);
    sendClicked ? $.__views.sendButton.addEventListener("click", sendClicked) : __defers["$.__views.sendButton!click!sendClicked"] = true;
    ...
    __defers["$.__views.sendButton!click!sendClicked"] && $.__views.sendButton.addEventListener("click", sendClicked);
    _.extend($, exports);
}
